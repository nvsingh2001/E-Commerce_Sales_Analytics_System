...
class S3Service:
    ...
    def create_folder_structure(self, bucket_name: str):
        self._s3_client.put_object(Bucket=bucket_name, Key="raw/")
        self._s3_client.put_object(Bucket=bucket_name, Key="curated/")

    def upload_file(self, file_path: str, bucket_name: str, key: str):
        self._s3_client.upload_file(file_path, bucket_name, key)
